...
class TabCalculadoraFamiliar extends StatefulWidget {
  ...
  @override
  State<TabCalculadoraFamiliar> createState() => _TabCalculadoraFamiliarState();
}

class _TabCalculadoraFamiliarState extends State<TabCalculadoraFamiliar> with TickerProviderStateMixin {
  // ── Estados de Introduccion ───────────────────
  ...
  Future<void> _verificarTutorial() async {
    ...
    final tutorialVisto = prefs.getBool('tutorial_conteo_cuidador_visto') ?? false;
  ...
  Future<void> _marcarTutorialVisto() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool('tutorial_conteo_cuidador_visto', true);
    if (mounted) {
      setState(() {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('Antes de empezar, ¿sabes cómo funciona el conteo de carbohidratos para calcular la insulina?', textAlign: TextAlign.center, style: TextStyle(fontSize: 15, color: Colors.black54, height: 1.4)),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 15),
              const Text('Es un método respaldado por médicos para calcular la cantidad EXACTA de insulina rápida que necesitas inyectar antes de comer. Todo depende de la comida y la glucosa actual.', style: TextStyle(fontSize: 15, color: Colors.black87, height: 1.5)),
              const SizedBox(height: 25),
              const Text('¿Cómo funciona en Insul App?', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black87)),
              const SizedBox(height: 15),
              _crearPasoTutorial('1', Icons.bloodtype, const Color(0xFFD32F2F), 'La Glucosa Actual', 'Primero revisamos cómo está el azúcar. Si está alta, la app calculará una "Dosis de Corrección" para bajarla al rango normal usando el Factor de Sensibilidad (FSI).'),
              _crearPasoTutorial('2', Icons.restaurant_menu, const Color(0xFFE65100), 'Lo que va a comer', 'Si come una manzana (15g de carbohidratos), la app calculará cuánta insulina necesita SOLO para esa manzana usando su Relación Insulina/Carbohidrato (RIC).'),
      ...
      hijo: Column(
        children: [
          ...
          _campoTexto(
            ...
            ayuda: 'Mide la glucosa justo antes de comer',
          ),
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: const Text('Redondea al 0.5 UI más cercano con el médico', style: TextStyle(fontSize: 11, color: Color(0xFF1565C0)), textAlign: TextAlign.center),
                ),
              ],
            ),
          ),
    ...
    return Container(
      ...
      child: const Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'ATENCIÓN: La glucosa indica hipoglucemia. NO administres insulina ahora. Dale 15 g de carbohidratos de acción rápida y espera 15 minutos.',
